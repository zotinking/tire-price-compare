...
비교 제품을 여러 개 등록한 경우에도 하나의 Chrome/Edge 실행 안에서 제품을 순서대로 수집합니다.
...
기존 자동화 창이 아직 열려 있어 프로필이 잠긴 경우에는 Chrome/Edge를 임시 프로필로 재시도합니다. 이때는 로그인 세션이 공유되지 않을 수 있으므로, 가능하면 이전 자동화 창을 닫고 다시 실행하세요.
